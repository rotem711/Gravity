    ...
    <div className={`${styles.root}`}>
      <div className="container default-grid ms:grid-cols-12 pt-35 pb-100 md:pb-115 xl:pb-155">
        <div className="col-span-full ms:col-span-7 md:col-span-7 xl:col-span-6">
          <h2 className="typo-subhead uppercase mb-75 md:mb-75">
          ...
          {sublineHeadlineMedia.link && (
            <div className="mt-45 md:mt-60 mb-90 ms:mb-0">
              <Button variant="light" link={sublineHeadlineMedia.link} />
            </div>
          )}
        </div>
        <div
          className={`${styles.mediaContainer} col-span-6 ms:col-span-5 md:col-span-5`}
        >
