...
const MediaWithCopyAndLinkModule:FunctionComponent<IMediaWithCopyAndLink> = (props) => {
  ...
  return (
    ...
    >
      <div className="container default-grid ms:grid-cols-12 pt-30 pb-180 md:pb-200">
        <div className="col-span-6 ms:col-span-8 ms:col-start-5">
          <LottiePlayer
            animation={mediaWithCopyAndLink.lottieSelect}
          />
        </div>
        <div className="col-span-6 sd:col-span-3 ms:col-span-5 xl:col-span-3 ms:col-start-5 xl:col-start-5 -top-40 md:-top-100 relative z-1">
