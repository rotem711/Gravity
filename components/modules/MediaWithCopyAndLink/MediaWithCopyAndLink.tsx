  ...
  return (
    ...
    >
      <div className="container default-grid pt-30 pb-180 md:pb-200">
        <div className="col-span-6 md:col-span-8 xl:col-span-8 xl:col-start-5">
          <LottiePlayer
            animation={mediaWithCopyAndLink.lottieSelect}
          />
        </div>
        <div className="col-span-6 md:col-span-5 xl:col-span-3 xl:col-start-5 -top-40 md:-top-30 xl:-top-100 relative z-1">
